...
<link rel="stylesheet"type="text/css" href="<%=request.getContextPath() %>/css/showlist.css">
...
<script src="<%=request.getContextPath() %>/js/header.js"></script>
	...
	<h1>商品一覧</h1>
	<a href="getallproduct">全件表示</a>
	<a href="getcolorproduct?colorcategory=1">ブラック</a>
